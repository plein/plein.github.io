...
export const LEVELS: Level[] = [
    ...
    },
    {
        ...
        toleranceDegrees: 20,
        missPenalty: { maxMisses: 2, durationMs: 500 },
    ...
    },
    {
        ...
        toleranceDegrees: 18,
        missPenalty: { maxMisses: 2, durationMs: 800 },
    ...
    },
    {
        ...
        toleranceDegrees: 18,
        missPenalty: { maxMisses: 3, durationMs: 900 },
    ...
    },
    {
        ...
        toleranceDegrees: 16,
        missPenalty: { maxMisses: 4, durationMs: 1000 },
    ...
    },
    {
        ...
        toleranceDegrees: 14,
        missPenalty: { maxMisses: 5, durationMs: 1100 },
    ...
    },
    {
        ...
        toleranceDegrees: 11,
        missPenalty: { maxMisses: 6, durationMs: 1400 },
        missAutoPauseDurationMs: 90,
    },
    {
        // L12: 7 clocks, real chaos begins
    ...
    },
    {
        ...
        toleranceDegrees: 10,
        missPenalty: { maxMisses: 7, durationMs: 1600 },
        missAutoPauseDurationMs: 85,
    },
    {
        ...
        toleranceDegrees: 9,
        missPenalty: { maxMisses: 7, durationMs: 1700 },
    ...
    },
    {
        ...
        baseSpeedRps: 0.95,
        numClocks: 8,
        stopDurationMs: 20000,
        speedIncrementPercent: 0.19,
        toleranceDegrees: 8,
        missPenalty: { maxMisses: 8, durationMs: 1800 },
        missAutoPauseDurationMs: 80,
    },
    {
        ...
        toleranceDegrees: 8,
        missPenalty: { maxMisses: 8, durationMs: 1900 },
    ...
    },
    {
        ...
        speedIncrementPercent: 0.20,
        toleranceDegrees: 7,
        missPenalty: { maxMisses: 8, durationMs: 2000 },
        missAutoPauseDurationMs: 75,
    },
    {
        ...
        toleranceDegrees: 6,
        missPenalty: { maxMisses: 8, durationMs: 2100 },
    ...
    },
    {
        ...
        toleranceDegrees: 5,
        missPenalty: { maxMisses: 8, durationMs: 2200 },
        missAutoPauseDurationMs: 70,
    },
    {
        ...
        speedIncrementPercent: 0.22,
        toleranceDegrees: 5,
        missPenalty: { maxMisses: 8, durationMs: 2300 },
        missAutoPauseDurationMs: 70,
    },
];
